...
abstract class WOWApi
{
  ...
  @GET('pvp-season/{pvpSeasonId}/pvp-leaderboard/{pvpBracket}?namespace=dynamic-us&locale=en_US&access_token=USWLBbPfjTjevf3unX4J6c2TX6aaog40j7')
  Future<LeaderBoard> getPvPRank(@Path('pvpSeasonId') int SeasonId, @Path('pvpBracket') String Bracket );
  @GET('pet/index?namespace=static-us&locale=en_US&access_token=USWLBbPfjTjevf3unX4J6c2TX6aaog40j7')
  Future<ListPet> getPet();
  @GET('pet/{petId}?namespace=static-us&locale=en_US&access_token=USWLBbPfjTjevf3unX4J6c2TX6aaog40j7')
  Future<PetDetail> searchPet(@Path('petId') int petId);
  @GET('quest/{questId}?namespace=static-us&locale=en_US&access_token=USWLBbPfjTjevf3unX4J6c2TX6aaog40j7')
  Future<Quests> SearchQuest(@Path('questId') int questId);
  @GET('pvp-season/{pvpSeasonId}/pvp-reward/index?namespace=static-us&locale=en_US&access_token=USWLBbPfjTjevf3unX4J6c2TX6aaog40j7')
